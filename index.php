<?php include_once "./include/header.php" ?>
   <div class="[ banner ] [ ft-nunito ]">
      <div class="container-full">
         <div class="[ text-content ]">
            <h2 class="[ header-text fw-bold ]">Women Security App</h2> 
            <p class="para-text">Report for cases of harrasment, abuse both online and real life</p>
         </div>
         <img class="banner-img" src="./assets/mockup.png" alt="">
      </div>
   </div>
   <div class="[ features ] [ ft-nunito ]">
      <div class="container-full">
         <h2 class="[ header-text fw-bold ]">Features</h2>
